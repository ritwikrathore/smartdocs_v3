...
5. **Exact Source References:** When referring to where information is found in the document (in the analysis_context field), provide the exact source reference as it appears in the document structure (e.g., "Article 5 - Payment Terms", "Section 9", "Schedule A - Definitions"). Use the LOCATION information from the chunk metadata. Do NOT mention chunk IDs or technical identifiers, and do NOT add extra descriptive text like "of the Loan Agreement" or "found in".
  ...
  "analyses": [
    {
      ...
      "analysis_context": "Exact source reference from the document (e.g., 'Article 5 - Payment Terms', 'Section 9', 'Schedule A - Definitions')"
    },
    {
      "sub_prompt_index": 2,
